...
const supplements: GameCatalogSupplements = {
    ...
    buffs: {
        ...
        character: [
            ...
            { id: 'cb-gi-yunjin', name: 'Cliffbreaker\'s Banner (NA DMG)', source: 'Yunjin', stat: 'flatDmgAdd', value: 4020, appliesTo: ['normal'], description: 'CORRECTED — was a static flat 45% dmgBonus; real value is a flat-DMG-add of 40.2% of Yun Jin’s own DEF at talent lvl 10 (was inconsistent with every sibling entry in this file that scales the same way).', scaleOff: { sourceStat: 'def', basis: 'total', ratio: 0.402 } },
            ...
            { id: 'cb-gi-xianyun', name: 'Starwicker (Plunge DMG)', source: 'Xianyun', stat: 'flatDmgAdd', value: 9000, appliesTo: ['plunge'], description: 'CORRECTED — was a flat 40% dmgBonus with no scaleOff; real P4 is a flat-DMG-add of 200% of Xianyun’s own ATK to party Plunging Attack DMG, capped at 9,000 (confirmed by the file’s own C2 entry already being exactly double this: 400%/18,000 cap).', scaleOff: { sourceStat: 'atk', basis: 'total', ratio: 2.0, cap: 9000 } },
            { id: 'cb-gi-yunjin-p2', name: 'Breaking Conventions (extra NA DMG)', source: 'Yunjin', stat: 'flatDmgAdd', value: 1150, appliesTo: ['normal'], description: 'P2: further increases the Cliffbreaker\'s Banner NA-DMG bonus by 2.5/5/7.5/11.5% of Yun Jin\'s DEF for 1/2/3/4 party Elemental Types — assumes the max case (4 types); toggle off for less-diverse parties.', scaleOff: { sourceStat: 'def', basis: 'total', ratio: 0.115 } },
            { id: 'cb-gi-xianyun-p1', name: 'Diverse Excellence (Plunge Crit Rate)', source: 'Xianyun', stat: 'critRate', value: 28, appliesTo: ['plunge'], description: 'P1: each of up to 4 enemies hit by her special Plunging Attack grants party Plunging Attack Crit Rate (4/6/8/10% per hit) — assumes the max case (all 4 stacks, 28% total); toggle off when fewer enemies are hit.' },
